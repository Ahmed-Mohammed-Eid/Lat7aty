...
const CourierForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!courier.courierName || !courier.birthdate || !courier.phoneNumber || !courier.companyName || !courier.carBrand || !courier.carModel || !courier.plateNumber || !courier.workingAreaId || !courier.workingShiftId || !courier.password || !courier.confirmPassword || !courier.licenseNumber || !courier.files || courier.hasFridge === null) {
        ...
        axios.post("https://api.lathaty.com/api/v1/create/courier", formData, {
            headers: {
    ...
    return (
        <>
            <form onSubmit={handleSubmit} className={"col-12 card"}>
                <h1 className="text-2xl mb-5 uppercase">Create Courier</h1>
