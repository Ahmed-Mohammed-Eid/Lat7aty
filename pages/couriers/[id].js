...
export default function Courier({ courier, orders }) {
    // VARIABLES
    let page = 1;
    let rowsPerPage = 25;
                    ...
                    <div className={"card-body"}>
                        <div className="grid">
                            ...
                            <div className="col-12 md:col-6 lg:col-3">
                                ...
                                <div>{courier?.workingAreaId?.areaName}</div>
                            </div>
                            <div className="col-12 md:col-6 lg:col-3">
                                <div className="font-bold">Zone Name:</div>
                                <div>{courier?.workingAreaId?.zoneName}</div>
                            </div>
                            ...
                            {courier?.documents?.length > 0 && (
                                <div className="col-12 card mt-4">
                                    ...
                                    <div className="grid mt-2 gap-2">
                                        {courier?.documents?.map(
                                            (attachment, index) => {
                                                return (
                                                    <a
                                                        key={attachment}
                                                        className={
                                                            "bg-info py-1 px-4 inline-block custom-button rounded-md col-12 md:col-6 lg:col-3"
                                                        }
                                                        style={{
                                                            color: "white",
                                                        }}
                        ...
                        >
                            <div className="grid col-12">
                                ...
                                <div className="col-6">
                                    <div className="font-bold">Has Fridge</div>
                                    <div>
                                        {selectedOrder?.courierId?.hasFridge ? (
                                            <span className={"text-success"}>
                                                Yes
                                            </span>
                                        ) : (
...
export async function getServerSideProps(ctx) {
    ...
    const response = await axios
        .get(`https://api.lathaty.com/api/v1/courier/orders`, {
            headers: {
    ...
    const courier = await axios
        .get(`https://api.lathaty.com/api/v1/get/courier`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
            params: {
